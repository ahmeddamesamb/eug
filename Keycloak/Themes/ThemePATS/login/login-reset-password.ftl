        ...
        <div class="droite col-12 col-md-5 d-flex flex-column justify-content-center align-items-center px-lg-5  image " > 
                ...
                <div class="text-center" style="width:100%; ">
                        ...
                        <#if section = "header">
                            ...
                            <div class="mt-3 mb-5 c-color" style=" font-size: 20px; color:#272727; font-weight: normal;">
                            Entrez votre nom d'utilisateur ou votre adresse e-mail et nous vous enverrons des instructions sur la façon de créer un nouveau mot de passe.
                            </div>
                        <#elseif section = "form">
