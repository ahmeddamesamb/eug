...
type RessourceFormGroupContent = {
  ...
  nomRessource: FormControl<IRessource['nomRessource']>;
  descriptionRessource: FormControl<IRessource['descriptionRessource']>;
};
...
export class RessourceFormService {
  createRessourceFormGroup(ressource: RessourceFormGroupInput = { id: null }): RessourceFormGroup {
    ...
    return new FormGroup<RessourceFormGroupContent>({
      ...
      nomRessource: new FormControl(ressourceRawValue.nomRessource),
      descriptionRessource: new FormControl(ressourceRawValue.descriptionRessource),
    });
  }
