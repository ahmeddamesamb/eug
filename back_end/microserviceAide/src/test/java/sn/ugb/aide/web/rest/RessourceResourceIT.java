...
class RessourceResourceIT {
    ...
    private static final String DEFAULT_NOM_RESSOURCE = "AAAAAAAAAA";
    private static final String UPDATED_NOM_RESSOURCE = "BBBBBBBBBB";

    private static final String DEFAULT_DESCRIPTION_RESSOURCE = "AAAAAAAAAA";
    private static final String UPDATED_DESCRIPTION_RESSOURCE = "BBBBBBBBBB";
    ...
    public static Ressource createEntity(EntityManager em) {
        Ressource ressource = new Ressource().nomRessource(DEFAULT_NOM_RESSOURCE).descriptionRessource(DEFAULT_DESCRIPTION_RESSOURCE);
        return ressource;
    }
    ...
    public static Ressource createUpdatedEntity(EntityManager em) {
        Ressource ressource = new Ressource().nomRessource(UPDATED_NOM_RESSOURCE).descriptionRessource(UPDATED_DESCRIPTION_RESSOURCE);
        return ressource;
    }
    ...
    void createRessource() throws Exception {
        ...
        assertThat(testRessource.getNomRessource()).isEqualTo(DEFAULT_NOM_RESSOURCE);
        assertThat(testRessource.getDescriptionRessource()).isEqualTo(DEFAULT_DESCRIPTION_RESSOURCE);
    }
    ...
    void getAllRessources() throws Exception {
        ...
        restRessourceMockMvc
            ...
            .andExpect(jsonPath("$.[*].nomRessource").value(hasItem(DEFAULT_NOM_RESSOURCE)))
            .andExpect(jsonPath("$.[*].descriptionRessource").value(hasItem(DEFAULT_DESCRIPTION_RESSOURCE)));
    }
    ...
    void getRessource() throws Exception {
        ...
        restRessourceMockMvc
            ...
            .andExpect(jsonPath("$.nomRessource").value(DEFAULT_NOM_RESSOURCE))
            .andExpect(jsonPath("$.descriptionRessource").value(DEFAULT_DESCRIPTION_RESSOURCE));
    }
    ...
    void putExistingRessource() throws Exception {
        ...
        updatedRessource.nomRessource(UPDATED_NOM_RESSOURCE).descriptionRessource(UPDATED_DESCRIPTION_RESSOURCE);
        ...
        Ressource testRessource = ressourceList.get(ressourceList.size() - 1);
        assertThat(testRessource.getNomRessource()).isEqualTo(UPDATED_NOM_RESSOURCE);
        assertThat(testRessource.getDescriptionRessource()).isEqualTo(UPDATED_DESCRIPTION_RESSOURCE);
    }
    ...
    void partialUpdateRessourceWithPatch() throws Exception {
        ...
        partialUpdatedRessource.nomRessource(UPDATED_NOM_RESSOURCE);
    ...
    void fullUpdateRessourceWithPatch() throws Exception {
        ...
        partialUpdatedRessource.nomRessource(UPDATED_NOM_RESSOURCE).descriptionRessource(UPDATED_DESCRIPTION_RESSOURCE);
