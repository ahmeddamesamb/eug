...
describe('PaiementFormationPrivee Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call InscriptionAdministrativeFormation query and add missing value', () => {
      ...
      const inscriptionAdministrativeFormation: IInscriptionAdministrativeFormation = { id: 25288 };
      paiementFormationPrivee.inscriptionAdministrativeFormation = inscriptionAdministrativeFormation;

      const inscriptionAdministrativeFormationCollection: IInscriptionAdministrativeFormation[] = [{ id: 2641 }];
      jest
    ...
    it('Should call Operateur query and add missing value', () => {
      const paiementFormationPrivee: IPaiementFormationPrivee = { id: 456 };
      const operateur: IOperateur = { id: 1563 };
      paiementFormationPrivee.operateur = operateur;

      const operateurCollection: IOperateur[] = [{ id: 3279 }];
    ...
    it('Should update editForm', () => {
      const paiementFormationPrivee: IPaiementFormationPrivee = { id: 456 };
      const inscriptionAdministrativeFormation: IInscriptionAdministrativeFormation = { id: 11930 };
      paiementFormationPrivee.inscriptionAdministrativeFormation = inscriptionAdministrativeFormation;
      const operateur: IOperateur = { id: 32511 };
      paiementFormationPrivee.operateur = operateur;
