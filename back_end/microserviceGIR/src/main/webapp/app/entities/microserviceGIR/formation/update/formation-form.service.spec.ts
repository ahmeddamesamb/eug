      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            classeDiplomanteYN: expect.any(Object),
            libelleDiplome: expect.any(Object),
            codeFormation: expect.any(Object),
            nbreCreditsMin: expect.any(Object),
            estParcoursYN: expect.any(Object),
            lmdYN: expect.any(Object),
