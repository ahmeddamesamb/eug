...
describe('PaiementFrais Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Frais query and add missing value', () => {
      ...
      const frais: IFrais = { id: 465 };
      paiementFrais.frais = frais;

      const fraisCollection: IFrais[] = [{ id: 11825 }];
    ...
    it('Should call Operateur query and add missing value', () => {
      ...
      const operateurCollection: IOperateur[] = [{ id: 4803 }];
    ...
    it('Should call InscriptionAdministrativeFormation query and add missing value', () => {
      const paiementFrais: IPaiementFrais = { id: 456 };
      const inscriptionAdministrativeFormation: IInscriptionAdministrativeFormation = { id: 15162 };
      paiementFrais.inscriptionAdministrativeFormation = inscriptionAdministrativeFormation;

      const inscriptionAdministrativeFormationCollection: IInscriptionAdministrativeFormation[] = [{ id: 10599 }];
      jest
    ...
    it('Should update editForm', () => {
      const paiementFrais: IPaiementFrais = { id: 456 };
      const frais: IFrais = { id: 23814 };
      paiementFrais.frais = frais;
      const operateur: IOperateur = { id: 11757 };
      paiementFrais.operateur = operateur;
      const inscriptionAdministrativeFormation: IInscriptionAdministrativeFormation = { id: 32734 };
      paiementFrais.inscriptionAdministrativeFormation = inscriptionAdministrativeFormation;
