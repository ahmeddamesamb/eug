...
describe('FormationInvalide Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Formation query and add missing value', () => {
      ...
      const formation: IFormation = { id: 8763 };
      formationInvalide.formation = formation;

      const formationCollection: IFormation[] = [{ id: 8580 }];
    ...
    it('Should call AnneeAcademique query and add missing value', () => {
      const formationInvalide: IFormationInvalide = { id: 456 };
      const anneAcademique: IAnneeAcademique = { id: 15379 };
      formationInvalide.anneAcademique = anneAcademique;

      const anneeAcademiqueCollection: IAnneeAcademique[] = [{ id: 26993 }];
      jest.spyOn(anneeAcademiqueService, 'query').mockReturnValue(of(new HttpResponse({ body: anneeAcademiqueCollection })));
      const additionalAnneeAcademiques = [anneAcademique];
    ...
    it('Should update editForm', () => {
      const formationInvalide: IFormationInvalide = { id: 456 };
      const formation: IFormation = { id: 3544 };
      formationInvalide.formation = formation;
      const anneAcademique: IAnneeAcademique = { id: 11703 };
      formationInvalide.anneAcademique = anneAcademique;
      ...
      expect(comp.anneeAcademiquesSharedCollection).toContain(anneAcademique);
