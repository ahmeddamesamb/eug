...
describe('InformationPersonnelle Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call etudiant query and add missing value', () => {
      ...
      const etudiant: IEtudiant = { id: 1009 };
      informationPersonnelle.etudiant = etudiant;

      const etudiantCollection: IEtudiant[] = [{ id: 30581 }];
    ...
    it('Should call TypeHandicap query and add missing value', () => {
      const informationPersonnelle: IInformationPersonnelle = { id: 456 };
      const typeHandique: ITypeHandicap = { id: 28923 };
      informationPersonnelle.typeHandique = typeHandique;
      ...
      const additionalTypeHandicaps = [typeHandique];
    ...
    it('Should update editForm', () => {
      const informationPersonnelle: IInformationPersonnelle = { id: 456 };
      const etudiant: IEtudiant = { id: 13317 };
      informationPersonnelle.etudiant = etudiant;
      const typeHandique: ITypeHandicap = { id: 23234 };
      informationPersonnelle.typeHandique = typeHandique;
      ...
      expect(comp.typeHandicapsSharedCollection).toContain(typeHandique);
