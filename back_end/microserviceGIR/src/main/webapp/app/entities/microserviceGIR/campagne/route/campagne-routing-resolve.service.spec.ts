...
import campagneResolve from './campagne-routing-resolve.service';

describe('Campagne routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: CampagneService;
  let resultCampagne: ICampagne | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ICampagne returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        campagneResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCampagne).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICampagne>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
