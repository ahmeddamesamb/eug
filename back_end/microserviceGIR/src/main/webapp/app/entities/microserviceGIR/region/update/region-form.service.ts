...
type RegionFormGroupContent = {
  ...
  libelleRegion: FormControl<IRegion['libelleRegion']>;
  pays: FormControl<IRegion['pays']>;
};
...
export class RegionFormService {
  createRegionFormGroup(region: RegionFormGroupInput = { id: null }): RegionFormGroup {
    ...
    return new FormGroup<RegionFormGroupContent>({
      ...
      libelleRegion: new FormControl(regionRawValue.libelleRegion, {
        validators: [Validators.required],
      }),
      pays: new FormControl(regionRawValue.pays),
    });
  }
