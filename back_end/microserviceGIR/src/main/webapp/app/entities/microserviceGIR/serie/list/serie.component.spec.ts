...
describe('Serie Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'microservicegir/serie', component: SerieComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to serieService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSerieIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSerieIdentifier).toHaveBeenCalledWith(entity);
