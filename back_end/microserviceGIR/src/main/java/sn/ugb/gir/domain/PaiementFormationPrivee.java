...
public class PaiementFormationPrivee implements Serializable {
    ...
    public Integer getPayerDelaisYN() {
        return this.payerDelaisYN;
    }

    public PaiementFormationPrivee payerDelaisYN(Integer payerDelaisYN) {
        this.setPayerDelaisYN(payerDelaisYN);
        return this;
    }

    public void setPayerDelaisYN(Integer payerDelaisYN) {
