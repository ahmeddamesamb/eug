...
/**
 * REST controller for managing {@link sn.ugb.gir.domain.Operation}.
 */
@RestController
...
public class OperationResource {
    ...
    private static final String ENTITY_NAME = "microserviceGirOperation";
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<OperationDTO>> getAllOperations(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
