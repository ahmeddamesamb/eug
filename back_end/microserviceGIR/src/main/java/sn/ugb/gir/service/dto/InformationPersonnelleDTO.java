...
public class InformationPersonnelleDTO implements Serializable {
    ...
    private TypeHandicapDTO typeHandique;
    ...
    public TypeHandicapDTO getTypeHandique() {
        return typeHandique;
    }

    public void setTypeHandique(TypeHandicapDTO typeHandique) {
        this.typeHandique = typeHandique;
    }
