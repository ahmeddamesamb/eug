...
public class InformationPersonnelle implements Serializable {
    ...
    private TypeHandicap typeHandique;
    ...
    public TypeHandicap getTypeHandique() {
        return this.typeHandique;
    }

    public void setTypeHandique(TypeHandicap typeHandicap) {
        this.typeHandique = typeHandicap;
    }

    public InformationPersonnelle typeHandique(TypeHandicap typeHandicap) {
        this.setTypeHandique(typeHandicap);
        return this;
    }
