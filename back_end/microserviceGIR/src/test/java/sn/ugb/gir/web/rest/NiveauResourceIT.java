...
class NiveauResourceIT {
    ...
    private static final Cycle DEFAULT_CYCLE_NIVEAU = Cycle.LICENCE;
    private static final Cycle UPDATED_CYCLE_NIVEAU = Cycle.MASTER;
    ...
    @Test
    @Transactional
    void checkCycleNiveauIsRequired() throws Exception {
        int databaseSizeBeforeTest = niveauRepository.findAll().size();
        // set the field null
        niveau.setCycleNiveau(null);
    ...
    void getAllNiveaus() throws Exception {
        ...
        restNiveauMockMvc
            ...
            .andExpect(jsonPath("$.[*].cycleNiveau").value(hasItem(DEFAULT_CYCLE_NIVEAU.toString())))
    ...
    void getNiveau() throws Exception {
        ...
        restNiveauMockMvc
            ...
            .andExpect(jsonPath("$.cycleNiveau").value(DEFAULT_CYCLE_NIVEAU.toString()))
