...
class InformationPersonnelleTest {
    ...
    @Test
    void typeHandiqueTest() throws Exception {
        InformationPersonnelle informationPersonnelle = getInformationPersonnelleRandomSampleGenerator();
        TypeHandicap typeHandicapBack = getTypeHandicapRandomSampleGenerator();

        informationPersonnelle.setTypeHandique(typeHandicapBack);
        assertThat(informationPersonnelle.getTypeHandique()).isEqualTo(typeHandicapBack);

        informationPersonnelle.typeHandique(null);
        assertThat(informationPersonnelle.getTypeHandique()).isNull();
    }
