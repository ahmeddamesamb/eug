...
class PaiementFraisResourceIT {
    ...
    private static final Integer DEFAULT_FORCLOS_YN = 1;
    private static final Integer UPDATED_FORCLOS_YN = 2;
    ...
    void getAllPaiementFrais() throws Exception {
        ...
        restPaiementFraisMockMvc
            ...
            .andExpect(jsonPath("$.[*].forclosYN").value(hasItem(DEFAULT_FORCLOS_YN)));
    }
    ...
    void getPaiementFrais() throws Exception {
        ...
        restPaiementFraisMockMvc
            ...
            .andExpect(jsonPath("$.forclosYN").value(DEFAULT_FORCLOS_YN));
    }
