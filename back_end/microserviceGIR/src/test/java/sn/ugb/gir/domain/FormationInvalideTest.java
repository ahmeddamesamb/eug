...
class FormationInvalideTest {
    ...
    @Test
    void anneAcademiqueTest() throws Exception {
        FormationInvalide formationInvalide = getFormationInvalideRandomSampleGenerator();
        AnneeAcademique anneeAcademiqueBack = getAnneeAcademiqueRandomSampleGenerator();

        formationInvalide.setAnneAcademique(anneeAcademiqueBack);
        assertThat(formationInvalide.getAnneAcademique()).isEqualTo(anneeAcademiqueBack);

        formationInvalide.anneAcademique(null);
        assertThat(formationInvalide.getAnneAcademique()).isNull();
    }
}
