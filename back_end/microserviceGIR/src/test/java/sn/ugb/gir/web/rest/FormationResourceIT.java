...
class FormationResourceIT {
    ...
    private static final TypeFormation DEFAULT_TYPE_FORMATION = TypeFormation.PUBLIC;
    private static final TypeFormation UPDATED_TYPE_FORMATION = TypeFormation.PRIVEE;
    ...
    @Test
    @Transactional
    void checkTypeFormationIsRequired() throws Exception {
