...
class AnneeAcademiqueResourceIT {
    ...
    private static final String DEFAULT_ANNEE_AC = "AAAA";
    private static final String UPDATED_ANNEE_AC = "BBBB";

    private static final Integer DEFAULT_ANNEE_COURANTE_YN = 1;
    private static final Integer UPDATED_ANNEE_COURANTE_YN = 2;
    ...
    void getAllAnneeAcademiques() throws Exception {
        ...
        restAnneeAcademiqueMockMvc
            ...
            .andExpect(jsonPath("$.[*].anneeCouranteYN").value(hasItem(DEFAULT_ANNEE_COURANTE_YN)));
    }
    ...
    void getAnneeAcademique() throws Exception {
        ...
        restAnneeAcademiqueMockMvc
            ...
            .andExpect(jsonPath("$.anneeCouranteYN").value(DEFAULT_ANNEE_COURANTE_YN));
    }
    ...
    void partialUpdateAnneeAcademiqueWithPatch() throws Exception {
        ...
        partialUpdatedAnneeAcademique.libelleAnneeAcademique(UPDATED_LIBELLE_ANNEE_ACADEMIQUE).anneeCouranteYN(UPDATED_ANNEE_COURANTE_YN);
