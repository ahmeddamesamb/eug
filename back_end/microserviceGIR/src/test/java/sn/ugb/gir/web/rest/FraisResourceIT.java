...
class FraisResourceIT {
    ...
    private static final Integer DEFAULT_FRAIS_POUR_ASSIMILE_YN = 1;
    private static final Integer UPDATED_FRAIS_POUR_ASSIMILE_YN = 2;
    ...
    @Test
    @Transactional
    void checkCycleIsRequired() throws Exception {
        int databaseSizeBeforeTest = fraisRepository.findAll().size();
        // set the field null
        frais.setCycle(null);
    ...
    void getAllFrais() throws Exception {
        ...
        restFraisMockMvc
            ...
            .andExpect(jsonPath("$.[*].fraisPourAssimileYN").value(hasItem(DEFAULT_FRAIS_POUR_ASSIMILE_YN)))
    ...
    void getFrais() throws Exception {
        ...
        restFraisMockMvc
            ...
            .andExpect(jsonPath("$.fraisPourAssimileYN").value(DEFAULT_FRAIS_POUR_ASSIMILE_YN))
