...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../candidat.test-samples';

import { CandidatService, RestCandidat } from './candidat.service';

const requireRestSample: RestCandidat = {
  ...sampleWithRequiredData,
  dateNaissanceCandidat: sampleWithRequiredData.dateNaissanceCandidat?.format(DATE_FORMAT),
};
