...
type RestOf<T extends ICandidat | NewCandidat> = Omit<T, 'dateNaissanceCandidat'> & {
  dateNaissanceCandidat?: string | null;
};
...
export class CandidatService {
  ...
  protected convertDateFromClient<T extends ICandidat | NewCandidat | PartialUpdateCandidat>(candidat: T): RestOf<T> {
    return {
      ...candidat,
      dateNaissanceCandidat: candidat.dateNaissanceCandidat?.format(DATE_FORMAT) ?? null,
    };
  }
  ...
  protected convertDateFromServer(restCandidat: RestCandidat): ICandidat {
    return {
      ...restCandidat,
      dateNaissanceCandidat: restCandidat.dateNaissanceCandidat ? dayjs(restCandidat.dateNaissanceCandidat) : undefined,
    };
  }
