...
public class EnseignementTestSamples {
    ...
    public static Enseignement getEnseignementSample1() {
        return new Enseignement().id(1L).libelleEnseignements("libelleEnseignements1").nombreInscrits(1).groupeYN(1);
    }

    public static Enseignement getEnseignementSample2() {
        return new Enseignement().id(2L).libelleEnseignements("libelleEnseignements2").nombreInscrits(2).groupeYN(2);
    }
    ...
    public static Enseignement getEnseignementRandomSampleGenerator() {
        return new Enseignement()
            ...
            .groupeYN(intCount.incrementAndGet());
    }
}
