...
public class Deliberation implements Serializable {
    ...
    @Column(name = "est_validee_yn")
    private Integer estValideeYN;
    ...
    public Integer getEstValideeYN() {
        return this.estValideeYN;
    }

    public Deliberation estValideeYN(Integer estValideeYN) {
        this.setEstValideeYN(estValideeYN);
        return this;
    }

    public void setEstValideeYN(Integer estValideeYN) {
