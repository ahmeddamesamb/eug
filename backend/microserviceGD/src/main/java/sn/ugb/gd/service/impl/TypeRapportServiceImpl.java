...
public class TypeRapportServiceImpl implements TypeRapportService {
    ...
    private final TypeRapportSearchRepository typeRapportSearchRepository;

    public TypeRapportServiceImpl(
        TypeRapportRepository typeRapportRepository,
        TypeRapportMapper typeRapportMapper,
        TypeRapportSearchRepository typeRapportSearchRepository
    ) {
        this.typeRapportRepository = typeRapportRepository;
        this.typeRapportMapper = typeRapportMapper;
        this.typeRapportSearchRepository = typeRapportSearchRepository;
    }
    ...
    public TypeRapportDTO save(TypeRapportDTO typeRapportDTO) {
        ...
        TypeRapportDTO result = typeRapportMapper.toDto(typeRapport);
        typeRapportSearchRepository.index(typeRapport);
        return result;
    }
    ...
    public Optional<TypeRapportDTO> partialUpdate(TypeRapportDTO typeRapportDTO) {
        ...
        return typeRapportRepository
            ...
            .map(savedTypeRapport -> {
                typeRapportSearchRepository.index(savedTypeRapport);
                return savedTypeRapport;
            })
    ...
    public void delete(Long id) {
        ...
        typeRapportSearchRepository.deleteFromIndexById(id);
    }

    @Override
    @Transactional(readOnly = true)
    public Page<TypeRapportDTO> search(String query, Pageable pageable) {
        log.debug("Request to search for a page of TypeRapports for query {}", query);
        return typeRapportSearchRepository.search(query, pageable).map(typeRapportMapper::toDto);
    }
}
