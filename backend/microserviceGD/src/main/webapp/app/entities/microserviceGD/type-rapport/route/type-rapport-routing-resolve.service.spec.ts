...
import typeRapportResolve from './type-rapport-routing-resolve.service';

describe('TypeRapport routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: TypeRapportService;
  let resultTypeRapport: ITypeRapport | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ITypeRapport returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        typeRapportResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultTypeRapport).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITypeRapport>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
