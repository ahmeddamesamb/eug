...
import sn.ugb.edt.config.Constants;
import sn.ugb.edt.domain.User;
import sn.ugb.edt.repository.UserRepository;
import sn.ugb.edt.repository.search.UserSearchRepository;
import sn.ugb.edt.security.AuthoritiesConstants;
import sn.ugb.edt.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the sn.ugb.edt.repository.search test package.
     *
     * @see sn.ugb.edt.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
