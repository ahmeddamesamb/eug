...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../planning.test-samples';
...
describe('Planning Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Planning', () => {
      ...
      service.create(planning).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Planning', () => {
      ...
      service.update(planning).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should handle exceptions for searching a Planning', () => {
    ...
    describe('addPlanningToCollectionIfMissing', () => {
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(planning);
        expect(expectedResult).toContain(planning2);
      });
