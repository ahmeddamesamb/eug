...
import sn.ugb.gateway.config.Constants;
import sn.ugb.gateway.domain.User;
import sn.ugb.gateway.repository.UserRepository;
import sn.ugb.gateway.repository.search.UserSearchRepository;
import sn.ugb.gateway.security.AuthoritiesConstants;
import sn.ugb.gateway.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the sn.ugb.gateway.repository.search test package.
     *
     * @see sn.ugb.gateway.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
