...
import sn.ugb.gateway.security.SecurityUtils;
import sn.ugb.gateway.security.oauth2.AudienceValidator;
import sn.ugb.gateway.security.oauth2.JwtGrantedAuthorityConverter;
import sn.ugb.gateway.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
        ...
        public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
                http
                                ...
                                authz
                                                ...
                                                // microfrontend resources are loaded by webpack without authentication,
                                                // they
                                                // need to be public
        ...
        private Consumer<OAuth2AuthorizationRequest.Builder> authorizationRequestCustomizer() {
                return customizer -> customizer.authorizationRequestUri(uriBuilder -> uriBuilder
                                .queryParam("audience", jHipsterProperties.getSecurity().getOauth2().getAudience())
                                .build());
        }
                                                ...
                                                .orElseGet(() -> WebClient
                                                                ...
                                                                .map(userInfo -> Jwt
                                                                                ...
                                                                                .claims(claims -> {
                                                                                        ...
                                                                                        // Allow full name in a name
                                                                                        // claim - happens with Auth0
                                                                                        if (userInfo.get(
                                                                                                        "name") != null) {
                                                                ...
                                                                .doOnNext(newJwt -> users.put(jwt.getSubject(),
                                                                                Mono.just(newJwt))));
                        }
                };
        }
