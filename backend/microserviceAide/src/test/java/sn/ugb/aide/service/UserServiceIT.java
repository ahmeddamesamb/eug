...
import sn.ugb.aide.config.Constants;
import sn.ugb.aide.domain.User;
import sn.ugb.aide.repository.UserRepository;
import sn.ugb.aide.repository.search.UserSearchRepository;
import sn.ugb.aide.security.AuthoritiesConstants;
import sn.ugb.aide.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the sn.ugb.aide.repository.search test package.
     *
     * @see sn.ugb.aide.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
