...
import sn.ugb.aclc.web.rest.errors.BadRequestAlertException;
import sn.ugb.aclc.web.rest.errors.ElasticsearchExceptionMapper;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.PaginationUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link sn.ugb.aclc.domain.Candidat}.
 */
@RestController
...
public class CandidatResource {
    ...
    private static final String ENTITY_NAME = "microserviceAclcCandidat";
    ...
    /**
     * {@code SEARCH  /candidats/_search?query=:query} : search for the candidat corresponding
     * to the query.
     *
     ...
     */
    @GetMapping("/_search")
    public ResponseEntity<List<CandidatDTO>> searchCandidats(
