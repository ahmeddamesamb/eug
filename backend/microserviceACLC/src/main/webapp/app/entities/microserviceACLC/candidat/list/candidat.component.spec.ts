...
describe('Candidat Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'microserviceaclc/candidat', component: CandidatComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.candidats?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to candidatService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCandidatIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCandidatIdentifier).toHaveBeenCalledWith(entity);
