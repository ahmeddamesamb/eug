...
public class InscriptionDoctoratServiceImpl implements InscriptionDoctoratService {
    ...
    private final InscriptionDoctoratSearchRepository inscriptionDoctoratSearchRepository;
    ...
    public InscriptionDoctoratServiceImpl(
        ...
        InscriptionDoctoratSearchRepository inscriptionDoctoratSearchRepository
    ) {
        this.inscriptionDoctoratRepository = inscriptionDoctoratRepository;
        this.inscriptionDoctoratMapper = inscriptionDoctoratMapper;
        this.inscriptionDoctoratSearchRepository = inscriptionDoctoratSearchRepository;
    }
    ...
    public InscriptionDoctoratDTO save(InscriptionDoctoratDTO inscriptionDoctoratDTO) {
        ...
        InscriptionDoctoratDTO result = inscriptionDoctoratMapper.toDto(inscriptionDoctorat);
        inscriptionDoctoratSearchRepository.index(inscriptionDoctorat);
        return result;
    }
    ...
    public Optional<InscriptionDoctoratDTO> partialUpdate(InscriptionDoctoratDTO inscriptionDoctoratDTO) {
        ...
        return inscriptionDoctoratRepository
            ...
            .map(savedInscriptionDoctorat -> {
                inscriptionDoctoratSearchRepository.index(savedInscriptionDoctorat);
                return savedInscriptionDoctorat;
            })
    ...
    public void delete(Long id) {
        ...
        inscriptionDoctoratSearchRepository.deleteFromIndexById(id);
    }

    @Override
    @Transactional(readOnly = true)
    public Page<InscriptionDoctoratDTO> search(String query, Pageable pageable) {
        log.debug("Request to search for a page of InscriptionDoctorats for query {}", query);
        return inscriptionDoctoratSearchRepository.search(query, pageable).map(inscriptionDoctoratMapper::toDto);
    }
}
