...
public class TypeSelectionResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<TypeSelectionDTO> createTypeSelection(@RequestBody TypeSelectionDTO typeSelectionDTO) throws URISyntaxException {
    ...
    public ResponseEntity<TypeSelectionDTO> updateTypeSelection(
        ...
        @RequestBody TypeSelectionDTO typeSelectionDTO
