...
public class FormationPriveeServiceImpl implements FormationPriveeService {
    ...
    public FormationPriveeServiceImpl(
        ...
        FormationPriveeSearchRepository formationPriveeSearchRepository
    ) {
    ...
    public FormationPriveeDTO save(FormationPriveeDTO formationPriveeDTO) {
        ...
        FormationPriveeDTO result = formationPriveeMapper.toDto(formationPrivee);
        formationPriveeSearchRepository.index(formationPrivee);
        return result;
    }
