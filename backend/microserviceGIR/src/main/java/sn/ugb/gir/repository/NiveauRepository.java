...
public interface NiveauRepository extends JpaRepository<Niveau, Long> {
    ...
    boolean existsByLibelleNiveauIgnoreCase(String libelleNiveau);

   // Page<Niveau> getAllNiveauByUniversiteId(Long universiteId, Pageable pageable);

   // Page<Niveau> getAllNiveauByMinistereId(Long ministereId, Pageable pageable);
