...
public class OperateurResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<OperateurDTO> createOperateur(@RequestBody OperateurDTO operateurDTO) throws URISyntaxException {
    ...
    public ResponseEntity<OperateurDTO> updateOperateur(
        ...
        @RequestBody OperateurDTO operateurDTO
