...
public class MinistereResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<MinistereDTO> createMinistere(@RequestBody MinistereDTO ministereDTO) throws URISyntaxException {
    ...
    public ResponseEntity<MinistereDTO> updateMinistere(
        ...
        @RequestBody MinistereDTO ministereDTO
