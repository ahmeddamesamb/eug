...
public class TypeBourseResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<TypeBourseDTO> createTypeBourse(@RequestBody TypeBourseDTO typeBourseDTO) throws URISyntaxException {
    ...
    public ResponseEntity<TypeBourseDTO> updateTypeBourse(
        ...
        @RequestBody TypeBourseDTO typeBourseDTO
