...
public class TypeAdmissionResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<TypeAdmissionDTO> createTypeAdmission(@RequestBody TypeAdmissionDTO typeAdmissionDTO) throws URISyntaxException {
    ...
    public ResponseEntity<TypeAdmissionDTO> updateTypeAdmission(
        ...
        @RequestBody TypeAdmissionDTO typeAdmissionDTO
