...
public class PaiementFraisResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<PaiementFraisDTO> createPaiementFrais(@RequestBody PaiementFraisDTO paiementFraisDTO) throws URISyntaxException {
    ...
    public ResponseEntity<PaiementFraisDTO> updatePaiementFrais(
        ...
        @RequestBody PaiementFraisDTO paiementFraisDTO
