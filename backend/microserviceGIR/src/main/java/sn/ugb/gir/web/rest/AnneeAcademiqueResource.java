...
public class AnneeAcademiqueResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<AnneeAcademiqueDTO> createAnneeAcademique(@RequestBody AnneeAcademiqueDTO anneeAcademiqueDTO)
    ...
    public ResponseEntity<AnneeAcademiqueDTO> updateAnneeAcademique(
        ...
        @RequestBody AnneeAcademiqueDTO anneeAcademiqueDTO
    ) throws URISyntaxException {
