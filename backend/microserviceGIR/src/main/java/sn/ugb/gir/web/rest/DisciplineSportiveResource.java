...
public class DisciplineSportiveResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<DisciplineSportiveDTO> createDisciplineSportive(@RequestBody DisciplineSportiveDTO disciplineSportiveDTO)
    ...
    public ResponseEntity<DisciplineSportiveDTO> updateDisciplineSportive(
        ...
        @RequestBody DisciplineSportiveDTO disciplineSportiveDTO
    ) throws URISyntaxException {
