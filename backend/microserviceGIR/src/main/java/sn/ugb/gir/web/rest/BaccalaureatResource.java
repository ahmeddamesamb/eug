...
public class BaccalaureatResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<BaccalaureatDTO> createBaccalaureat(@Valid @RequestBody BaccalaureatDTO baccalaureatDTO)
    ...
    public ResponseEntity<BaccalaureatDTO> updateBaccalaureat(
        ...
        @Valid @RequestBody BaccalaureatDTO baccalaureatDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<BaccalaureatDTO> partialUpdateBaccalaureat(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody BaccalaureatDTO baccalaureatDTO
    ) throws URISyntaxException {
