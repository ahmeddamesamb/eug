...
const routes: Routes = [
  ...
  {
    path: 'processus-dinscription-administrative',
    data: { pageTitle: 'microserviceGirApp.microserviceGirProcessusDinscriptionAdministrative.home.title' },
    loadChildren: () => import('./microserviceGIR/processus-dinscription-administrative/processus-dinscription-administrative.routes'),
  },
  {
    path: 'operation',
  ...
  {
    path: 'formation-valide',
    data: { pageTitle: 'microserviceGirApp.microserviceGirFormationValide.home.title' },
    loadChildren: () => import('./microserviceGIR/formation-valide/formation-valide.routes'),
  },
  {
    path: 'mention',
