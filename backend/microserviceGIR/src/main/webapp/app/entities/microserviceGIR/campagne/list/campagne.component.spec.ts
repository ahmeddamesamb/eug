...
describe('Campagne Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'microservicegir/campagne', component: CampagneComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.campagnes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to campagneService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCampagneIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCampagneIdentifier).toHaveBeenCalledWith(entity);
