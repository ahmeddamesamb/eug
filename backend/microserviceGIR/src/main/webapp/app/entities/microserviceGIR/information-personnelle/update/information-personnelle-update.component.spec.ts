...
describe('InformationPersonnelle Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call TypeHandicap query and add missing value', () => {
      const informationPersonnelle: IInformationPersonnelle = { id: 456 };
      const typeHadique: ITypeHandicap = { id: 28923 };
      informationPersonnelle.typeHadique = typeHadique;
      ...
      const additionalTypeHandicaps = [typeHadique];
    ...
    it('Should update editForm', () => {
      ...
      informationPersonnelle.etudiant = etudiant;
      const typeHadique: ITypeHandicap = { id: 23234 };
      informationPersonnelle.typeHadique = typeHadique;
      ...
      expect(comp.typeHandicapsSharedCollection).toContain(typeHadique);
