...
describe('Operateur Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'microservicegir/operateur', component: OperateurComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to operateurService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOperateurIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOperateurIdentifier).toHaveBeenCalledWith(entity);
