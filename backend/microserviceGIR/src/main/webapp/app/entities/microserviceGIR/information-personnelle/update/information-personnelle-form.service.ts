...
type InformationPersonnelleFormDefaults = Pick<NewInformationPersonnelle, 'id' | 'handicapYN' | 'ordiPersoYN'>;
...
type InformationPersonnelleFormGroupContent = {
  ...
  typeHandicap: FormControl<IInformationPersonnelle['typeHandicap']>;
...
export class InformationPersonnelleFormService {
  createInformationPersonnelleFormGroup(
    ...
    return new FormGroup<InformationPersonnelleFormGroupContent>({
      ...
      typeHandicap: new FormControl(informationPersonnelleRawValue.typeHandicap),
