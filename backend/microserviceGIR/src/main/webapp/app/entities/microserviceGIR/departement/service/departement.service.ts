...
export class DepartementService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/departements', 'microservicegir');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/departements/_search', 'microservicegir');
