...
import serieResolve from './serie-routing-resolve.service';

describe('Serie routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: SerieService;
  let resultSerie: ISerie | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ISerie returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        serieResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultSerie = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultSerie).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ISerie>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
