...
export class DisciplineSportiveEtudiantService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor(
    'api/discipline-sportive-etudiants/_search',
    'microservicegir',
  );
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http
      .get<IDisciplineSportiveEtudiant[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
      .pipe(catchError(() => scheduled([new HttpResponse<IDisciplineSportiveEtudiant[]>()], asapScheduler)));
  }
