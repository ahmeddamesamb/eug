...
describe('Niveau Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'microservicegir/niveau', component: NiveauComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to niveauService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getNiveauIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getNiveauIdentifier).toHaveBeenCalledWith(entity);
