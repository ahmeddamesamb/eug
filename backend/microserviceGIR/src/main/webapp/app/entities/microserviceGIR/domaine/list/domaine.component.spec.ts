...
describe('Domaine Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'microservicegir/domaine', component: DomaineComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to domaineService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDomaineIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDomaineIdentifier).toHaveBeenCalledWith(entity);
