...
type UniversiteFormDefaults = Pick<NewUniversite, 'id' | 'actifYN'>;

type UniversiteFormGroupContent = {
  id: FormControl<IUniversite['id'] | NewUniversite['id']>;
  nomUniversite: FormControl<IUniversite['nomUniversite']>;
  sigleUniversite: FormControl<IUniversite['sigleUniversite']>;
  actifYN: FormControl<IUniversite['actifYN']>;
  ministere: FormControl<IUniversite['ministere']>;
};
...
export class UniversiteFormService {
  createUniversiteFormGroup(universite: UniversiteFormGroupInput = { id: null }): UniversiteFormGroup {
    ...
    return new FormGroup<UniversiteFormGroupContent>({
      ...
      nomUniversite: new FormControl(universiteRawValue.nomUniversite, {
        validators: [Validators.required],
      }),
      sigleUniversite: new FormControl(universiteRawValue.sigleUniversite, {
        validators: [Validators.required],
      }),
      actifYN: new FormControl(universiteRawValue.actifYN, {
        validators: [Validators.required],
      }),
      ministere: new FormControl(universiteRawValue.ministere),
    });
  }
