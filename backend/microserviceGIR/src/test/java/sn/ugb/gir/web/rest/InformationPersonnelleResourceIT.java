...
class InformationPersonnelleResourceIT {
    ...
    private static final Boolean DEFAULT_HANDICAP_YN = false;
    private static final Boolean UPDATED_HANDICAP_YN = true;

    private static final String DEFAULT_PHOTO = "AAAAAAAAAA";
    private static final String UPDATED_PHOTO = "BBBBBBBBBB";

    private static final Boolean DEFAULT_ORDI_PERSO_YN = false;
    private static final Boolean UPDATED_ORDI_PERSO_YN = true;
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/information-personnelles/_search";
    ...
    @Autowired
    private InformationPersonnelleSearchRepository informationPersonnelleSearchRepository;
    ...
    public void cleanupElasticSearchRepository() {
        informationPersonnelleSearchRepository.deleteAll();
        assertThat(informationPersonnelleSearchRepository.count()).isEqualTo(0);
    }
    ...
    void createInformationPersonnelle() throws Exception {
        ...
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(informationPersonnelleSearchRepository.findAll());
        ...
        await()
            ...
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(informationPersonnelleSearchRepository.findAll());
    ...
    void getAllInformationPersonnelles() throws Exception {
        ...
        restInformationPersonnelleMockMvc
            ...
            .andExpect(jsonPath("$.[*].handicapYN").value(hasItem(DEFAULT_HANDICAP_YN.booleanValue())))
            .andExpect(jsonPath("$.[*].photo").value(hasItem(DEFAULT_PHOTO)))
            .andExpect(jsonPath("$.[*].ordiPersoYN").value(hasItem(DEFAULT_ORDI_PERSO_YN.booleanValue())))
    ...
    void getInformationPersonnelle() throws Exception {
        ...
        restInformationPersonnelleMockMvc
            ...
            .andExpect(jsonPath("$.handicapYN").value(DEFAULT_HANDICAP_YN.booleanValue()))
            .andExpect(jsonPath("$.photo").value(DEFAULT_PHOTO))
            .andExpect(jsonPath("$.ordiPersoYN").value(DEFAULT_ORDI_PERSO_YN.booleanValue()))
    ...
    void putExistingInformationPersonnelle() throws Exception {
        ...
        informationPersonnelleSearchRepository.save(informationPersonnelle);
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(informationPersonnelleSearchRepository.findAll());
        ...
        await()
            ...
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(informationPersonnelleSearchRepository.findAll());
                assertThat(searchDatabaseSizeAfter).isEqualTo(searchDatabaseSizeBefore);
                List<InformationPersonnelle> informationPersonnelleSearchList = IterableUtils.toList(
                    informationPersonnelleSearchRepository.findAll()
                );
                InformationPersonnelle testInformationPersonnelleSearch = informationPersonnelleSearchList.get(searchDatabaseSizeAfter - 1);
                assertThat(testInformationPersonnelleSearch.getNomEtu()).isEqualTo(UPDATED_NOM_ETU);
                assertThat(testInformationPersonnelleSearch.getNomJeuneFilleEtu()).isEqualTo(UPDATED_NOM_JEUNE_FILLE_ETU);
                assertThat(testInformationPersonnelleSearch.getPrenomEtu()).isEqualTo(UPDATED_PRENOM_ETU);
                assertThat(testInformationPersonnelleSearch.getStatutMarital()).isEqualTo(UPDATED_STATUT_MARITAL);
                assertThat(testInformationPersonnelleSearch.getRegime()).isEqualTo(UPDATED_REGIME);
                assertThat(testInformationPersonnelleSearch.getProfession()).isEqualTo(UPDATED_PROFESSION);
                assertThat(testInformationPersonnelleSearch.getAdresseEtu()).isEqualTo(UPDATED_ADRESSE_ETU);
                assertThat(testInformationPersonnelleSearch.getTelEtu()).isEqualTo(UPDATED_TEL_ETU);
                assertThat(testInformationPersonnelleSearch.getEmailEtu()).isEqualTo(UPDATED_EMAIL_ETU);
                assertThat(testInformationPersonnelleSearch.getAdresseParent()).isEqualTo(UPDATED_ADRESSE_PARENT);
                assertThat(testInformationPersonnelleSearch.getTelParent()).isEqualTo(UPDATED_TEL_PARENT);
                assertThat(testInformationPersonnelleSearch.getEmailParent()).isEqualTo(UPDATED_EMAIL_PARENT);
                assertThat(testInformationPersonnelleSearch.getNomParent()).isEqualTo(UPDATED_NOM_PARENT);
                assertThat(testInformationPersonnelleSearch.getPrenomParent()).isEqualTo(UPDATED_PRENOM_PARENT);
                assertThat(testInformationPersonnelleSearch.getHandicapYN()).isEqualTo(UPDATED_HANDICAP_YN);
                assertThat(testInformationPersonnelleSearch.getPhoto()).isEqualTo(UPDATED_PHOTO);
                assertThat(testInformationPersonnelleSearch.getOrdiPersoYN()).isEqualTo(UPDATED_ORDI_PERSO_YN);
                assertThat(testInformationPersonnelleSearch.getDerniereModification()).isEqualTo(UPDATED_DERNIERE_MODIFICATION);
                assertThat(testInformationPersonnelleSearch.getEmailUser()).isEqualTo(UPDATED_EMAIL_USER);
            });
    }
    ...
    @Test
    @Transactional
    void searchInformationPersonnelle() throws Exception {
        // Initialize the database
        informationPersonnelle = informationPersonnelleRepository.saveAndFlush(informationPersonnelle);
        informationPersonnelleSearchRepository.save(informationPersonnelle);

        // Search the informationPersonnelle
        restInformationPersonnelleMockMvc
            .perform(get(ENTITY_SEARCH_API_URL + "?query=id:" + informationPersonnelle.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(informationPersonnelle.getId().intValue())))
            .andExpect(jsonPath("$.[*].nomEtu").value(hasItem(DEFAULT_NOM_ETU)))
