...
class TypeBourseResourceIT {
    ...
    public static TypeBourse createEntity(EntityManager em) {
        TypeBourse typeBourse = new TypeBourse().libelle(DEFAULT_LIBELLE);
        return typeBourse;
    }
    ...
    public static TypeBourse createUpdatedEntity(EntityManager em) {
        TypeBourse typeBourse = new TypeBourse().libelle(UPDATED_LIBELLE);
        return typeBourse;
    }
    ...
    void createTypeBourse() throws Exception {
        ...
        assertThat(testTypeBourse.getLibelle()).isEqualTo(DEFAULT_LIBELLE);
    }
    ...
    void putExistingTypeBourse() throws Exception {
        ...
        updatedTypeBourse.libelle(UPDATED_LIBELLE);
        ...
        TypeBourse testTypeBourse = typeBourseList.get(typeBourseList.size() - 1);
        assertThat(testTypeBourse.getLibelle()).isEqualTo(UPDATED_LIBELLE);
    }
    ...
    void partialUpdateTypeBourseWithPatch() throws Exception {
        ...
        partialUpdatedTypeBourse.libelle(UPDATED_LIBELLE);
