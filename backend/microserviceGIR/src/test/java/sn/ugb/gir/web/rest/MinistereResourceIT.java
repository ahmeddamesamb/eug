...
class MinistereResourceIT {
    ...
    void createMinistere() throws Exception {
        ...
        assertThat(testMinistere.getEnCours()).isEqualTo(DEFAULT_EN_COURS);
    }
    ...
    void putExistingMinistere() throws Exception {
        ...
        assertThat(testMinistere.getEnCours()).isEqualTo(UPDATED_EN_COURS);
    }
    ...
    void partialUpdateMinistereWithPatch() throws Exception {
        ...
        partialUpdatedMinistere.dateDebut(UPDATED_DATE_DEBUT).dateFin(UPDATED_DATE_FIN).enCours(UPDATED_EN_COURS);
