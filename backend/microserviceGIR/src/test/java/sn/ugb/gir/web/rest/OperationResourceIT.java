...
import sn.ugb.gir.repository.search.OperationSearchRepository;
    ...
    void putExistingOperation() throws Exception {
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(testOperationSearch.getDateExecution()).isEqualTo(UPDATED_DATE_EXECUTION);
                assertThat(testOperationSearch.getEmailUser()).isEqualTo(UPDATED_EMAIL_USER);
                assertThat(testOperationSearch.getDetailOperation()).isEqualTo(UPDATED_DETAIL_OPERATION);
                assertThat(testOperationSearch.getInfoSysteme()).isEqualTo(UPDATED_INFO_SYSTEME);
            });
    }
