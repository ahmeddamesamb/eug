...
class FormationAutoriseeResourceIT {
    ...
    private static final LocalDate DEFAULT_DATE_DEBU_T = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE_DEBU_T = LocalDate.now(ZoneId.systemDefault());

    private static final LocalDate DEFAULT_DATE_FIN = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE_FIN = LocalDate.now(ZoneId.systemDefault());

    private static final Integer DEFAULT_EN_COURS = 1;
    private static final Integer UPDATED_EN_COURS = 2;
    ...
    void createFormationAutorisee() throws Exception {
        ...
        assertThat(testFormationAutorisee.getDateDebuT()).isEqualTo(DEFAULT_DATE_DEBU_T);
        assertThat(testFormationAutorisee.getDateFin()).isEqualTo(DEFAULT_DATE_FIN);
        assertThat(testFormationAutorisee.getEnCours()).isEqualTo(DEFAULT_EN_COURS);
    }
    ...
    void getAllFormationAutorisees() throws Exception {
        ...
        restFormationAutoriseeMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateDebuT").value(hasItem(DEFAULT_DATE_DEBU_T.toString())))
    ...
    void getFormationAutorisee() throws Exception {
        ...
        restFormationAutoriseeMockMvc
            ...
            .andExpect(jsonPath("$.dateDebuT").value(DEFAULT_DATE_DEBU_T.toString()))
    ...
    void putExistingFormationAutorisee() throws Exception {
        ...
        updatedFormationAutorisee.dateDebuT(UPDATED_DATE_DEBU_T).dateFin(UPDATED_DATE_FIN).enCours(UPDATED_EN_COURS);
        ...
        FormationAutorisee testFormationAutorisee = formationAutoriseeList.get(formationAutoriseeList.size() - 1);
        assertThat(testFormationAutorisee.getDateDebuT()).isEqualTo(UPDATED_DATE_DEBU_T);
        assertThat(testFormationAutorisee.getDateFin()).isEqualTo(UPDATED_DATE_FIN);
        assertThat(testFormationAutorisee.getEnCours()).isEqualTo(UPDATED_EN_COURS);
    }
    ...
    void partialUpdateFormationAutoriseeWithPatch() throws Exception {
        ...
        partialUpdatedFormationAutorisee.dateDebuT(UPDATED_DATE_DEBU_T).enCours(UPDATED_EN_COURS);
    ...
    void fullUpdateFormationAutoriseeWithPatch() throws Exception {
        ...
        partialUpdatedFormationAutorisee.dateDebuT(UPDATED_DATE_DEBU_T).dateFin(UPDATED_DATE_FIN).enCours(UPDATED_EN_COURS);
