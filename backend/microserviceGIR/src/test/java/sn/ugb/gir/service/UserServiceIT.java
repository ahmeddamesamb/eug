...
import sn.ugb.gir.config.Constants;
import sn.ugb.gir.domain.User;
import sn.ugb.gir.repository.UserRepository;
import sn.ugb.gir.repository.search.UserSearchRepository;
import sn.ugb.gir.security.AuthoritiesConstants;
import sn.ugb.gir.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the sn.ugb.gir.repository.search test package.
     *
     * @see sn.ugb.gir.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
