...
class InformationPersonnelleTest {
    ...
    @Test
    void typeHandicapTest() throws Exception {
        InformationPersonnelle informationPersonnelle = getInformationPersonnelleRandomSampleGenerator();
        TypeHandicap typeHandicapBack = getTypeHandicapRandomSampleGenerator();

        informationPersonnelle.setTypeHandicap(typeHandicapBack);
        assertThat(informationPersonnelle.getTypeHandicap()).isEqualTo(typeHandicapBack);

        informationPersonnelle.typeHandicap(null);
        assertThat(informationPersonnelle.getTypeHandicap()).isNull();
    }
