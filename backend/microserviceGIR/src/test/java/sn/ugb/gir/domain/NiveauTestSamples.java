...
public class NiveauTestSamples {
    ...
    public static Niveau getNiveauSample1() {
        return new Niveau().id(1L).libelleNiveau("libelleNiveau1").codeNiveau("codeNiveau1").anneeEtude("anneeEtude1");
    }

    public static Niveau getNiveauSample2() {
        return new Niveau().id(2L).libelleNiveau("libelleNiveau2").codeNiveau("codeNiveau2").anneeEtude("anneeEtude2");
    }
