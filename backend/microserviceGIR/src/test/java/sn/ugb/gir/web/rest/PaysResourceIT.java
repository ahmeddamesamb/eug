...
class PaysResourceIT {
    ...
    private static final Integer DEFAULT_U_EMOAYN = 1;
    private static final Integer UPDATED_U_EMOAYN = 2;

    private static final Integer DEFAULT_C_EDEAOYN = 1;
    private static final Integer UPDATED_C_EDEAOYN = 2;

    private static final Integer DEFAULT_R_IMYN = 1;
    private static final Integer UPDATED_R_IMYN = 2;

    private static final Integer DEFAULT_AUTRE_YN = 1;
    private static final Integer UPDATED_AUTRE_YN = 2;

    private static final Integer DEFAULT_EST_ETRANGER_YN = 1;
    private static final Integer UPDATED_EST_ETRANGER_YN = 2;
    ...
    void getAllPays() throws Exception {
        ...
        restPaysMockMvc
            ...
            .andExpect(jsonPath("$.[*].uEMOAYN").value(hasItem(DEFAULT_U_EMOAYN)))
            .andExpect(jsonPath("$.[*].cEDEAOYN").value(hasItem(DEFAULT_C_EDEAOYN)))
            .andExpect(jsonPath("$.[*].rIMYN").value(hasItem(DEFAULT_R_IMYN)))
            .andExpect(jsonPath("$.[*].autreYN").value(hasItem(DEFAULT_AUTRE_YN)))
            .andExpect(jsonPath("$.[*].estEtrangerYN").value(hasItem(DEFAULT_EST_ETRANGER_YN)));
    }
    ...
    void getPays() throws Exception {
        ...
        restPaysMockMvc
            ...
            .andExpect(jsonPath("$.uEMOAYN").value(DEFAULT_U_EMOAYN))
            .andExpect(jsonPath("$.cEDEAOYN").value(DEFAULT_C_EDEAOYN))
            .andExpect(jsonPath("$.rIMYN").value(DEFAULT_R_IMYN))
            .andExpect(jsonPath("$.autreYN").value(DEFAULT_AUTRE_YN))
            .andExpect(jsonPath("$.estEtrangerYN").value(DEFAULT_EST_ETRANGER_YN));
    }
