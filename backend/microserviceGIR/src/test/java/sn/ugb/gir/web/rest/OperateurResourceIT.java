...
class OperateurResourceIT {
    ...
    public static Operateur createEntity(EntityManager em) {
        Operateur operateur = new Operateur().libelle(DEFAULT_LIBELLE).userLogin(DEFAULT_USER_LOGIN).codeOperateur(DEFAULT_CODE_OPERATEUR);
        return operateur;
    }
    ...
    public static Operateur createUpdatedEntity(EntityManager em) {
        Operateur operateur = new Operateur().libelle(UPDATED_LIBELLE).userLogin(UPDATED_USER_LOGIN).codeOperateur(UPDATED_CODE_OPERATEUR);
        return operateur;
    }
    ...
    void putExistingOperateur() throws Exception {
        ...
        updatedOperateur.libelle(UPDATED_LIBELLE).userLogin(UPDATED_USER_LOGIN).codeOperateur(UPDATED_CODE_OPERATEUR);
    ...
    void partialUpdateOperateurWithPatch() throws Exception {
        ...
        partialUpdatedOperateur.libelle(UPDATED_LIBELLE).codeOperateur(UPDATED_CODE_OPERATEUR);
    ...
    void fullUpdateOperateurWithPatch() throws Exception {
        ...
        partialUpdatedOperateur.libelle(UPDATED_LIBELLE).userLogin(UPDATED_USER_LOGIN).codeOperateur(UPDATED_CODE_OPERATEUR);
