...
class BaccalaureatResourceIT {
    ...
    @Test
    @Transactional
    void checkAnneeBacIsRequired() throws Exception {
        int databaseSizeBeforeTest = baccalaureatRepository.findAll().size();
        // set the field null
        baccalaureat.setAnneeBac(null);

        // Create the Baccalaureat, which fails.
        BaccalaureatDTO baccalaureatDTO = baccalaureatMapper.toDto(baccalaureat);
        ...
        List<Baccalaureat> baccalaureatList = baccalaureatRepository.findAll();
        assertThat(baccalaureatList).hasSize(databaseSizeBeforeTest);
    }

    @Test
    @Transactional
    void checkNumeroTableIsRequired() throws Exception {
        int databaseSizeBeforeTest = baccalaureatRepository.findAll().size();
        // set the field null
        baccalaureat.setNumeroTable(null);
    ...
    @Test
    @Transactional
    void checkMentionBacIsRequired() throws Exception {
        int databaseSizeBeforeTest = baccalaureatRepository.findAll().size();
        // set the field null
        baccalaureat.setMentionBac(null);
    ...
    @Test
    @Transactional
    void checkMoyenneBacIsRequired() throws Exception {
        int databaseSizeBeforeTest = baccalaureatRepository.findAll().size();
        // set the field null
        baccalaureat.setMoyenneBac(null);
