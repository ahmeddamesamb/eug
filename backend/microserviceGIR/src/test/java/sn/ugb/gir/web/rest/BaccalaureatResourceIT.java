...
class BaccalaureatResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/baccalaureats/_search";
    ...
    @Autowired
    private BaccalaureatSearchRepository baccalaureatSearchRepository;
    ...
    public void cleanupElasticSearchRepository() {
        baccalaureatSearchRepository.deleteAll();
        assertThat(baccalaureatSearchRepository.count()).isEqualTo(0);
    }
    ...
    void createBaccalaureat() throws Exception {
        ...
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(baccalaureatSearchRepository.findAll());
        ...
        await()
            ...
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(baccalaureatSearchRepository.findAll());
        ...
        assertThat(testBaccalaureat.getActifYN()).isEqualTo(DEFAULT_ACTIF_YN);
    }
    ...
    void putExistingBaccalaureat() throws Exception {
        ...
        baccalaureatSearchRepository.save(baccalaureat);
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(baccalaureatSearchRepository.findAll());
        ...
        assertThat(testBaccalaureat.getActifYN()).isEqualTo(UPDATED_ACTIF_YN);
        await()
            .atMost(5, TimeUnit.SECONDS)
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(baccalaureatSearchRepository.findAll());
                assertThat(searchDatabaseSizeAfter).isEqualTo(searchDatabaseSizeBefore);
                List<Baccalaureat> baccalaureatSearchList = IterableUtils.toList(baccalaureatSearchRepository.findAll());
                Baccalaureat testBaccalaureatSearch = baccalaureatSearchList.get(searchDatabaseSizeAfter - 1);
                assertThat(testBaccalaureatSearch.getOrigineScolaire()).isEqualTo(UPDATED_ORIGINE_SCOLAIRE);
                assertThat(testBaccalaureatSearch.getAnneeBac()).isEqualTo(UPDATED_ANNEE_BAC);
                assertThat(testBaccalaureatSearch.getNumeroTable()).isEqualTo(UPDATED_NUMERO_TABLE);
                assertThat(testBaccalaureatSearch.getNatureBac()).isEqualTo(UPDATED_NATURE_BAC);
                assertThat(testBaccalaureatSearch.getMentionBac()).isEqualTo(UPDATED_MENTION_BAC);
                assertThat(testBaccalaureatSearch.getMoyenneSelectionBac()).isEqualTo(UPDATED_MOYENNE_SELECTION_BAC);
                assertThat(testBaccalaureatSearch.getMoyenneBac()).isEqualTo(UPDATED_MOYENNE_BAC);
                assertThat(testBaccalaureatSearch.getActifYN()).isEqualTo(UPDATED_ACTIF_YN);
            });
    }
    ...
    void partialUpdateBaccalaureatWithPatch() throws Exception {
        ...
        partialUpdatedBaccalaureat.anneeBac(UPDATED_ANNEE_BAC).moyenneBac(UPDATED_MOYENNE_BAC).actifYN(UPDATED_ACTIF_YN);
    ...
    @Test
    @Transactional
    void searchBaccalaureat() throws Exception {
        // Initialize the database
        baccalaureat = baccalaureatRepository.saveAndFlush(baccalaureat);
        baccalaureatSearchRepository.save(baccalaureat);

        // Search the baccalaureat
        restBaccalaureatMockMvc
            .perform(get(ENTITY_SEARCH_API_URL + "?query=id:" + baccalaureat.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(baccalaureat.getId().intValue())))
            .andExpect(jsonPath("$.[*].origineScolaire").value(hasItem(DEFAULT_ORIGINE_SCOLAIRE)))
