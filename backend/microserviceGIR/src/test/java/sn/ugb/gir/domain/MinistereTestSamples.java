...
public class MinistereTestSamples {
    ...
    public static Ministere getMinistereSample1() {
        return new Ministere().id(1L).nomMinistere("nomMinistere1").sigleMinistere("sigleMinistere1").enCours(1);
    }

    public static Ministere getMinistereSample2() {
        return new Ministere().id(2L).nomMinistere("nomMinistere2").sigleMinistere("sigleMinistere2").enCours(2);
    }
    ...
    public static Ministere getMinistereRandomSampleGenerator() {
        return new Ministere()
            ...
            .enCours(intCount.incrementAndGet());
    }
}
