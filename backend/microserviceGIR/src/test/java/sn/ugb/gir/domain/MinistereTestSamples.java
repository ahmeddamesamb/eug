...
public class MinistereTestSamples {
    ...
    public static Ministere getMinistereSample1() {
        return new Ministere().id(1L).nomMinistere("nomMinistere1").sigleMinistere("sigleMinistere1");
    }

    public static Ministere getMinistereSample2() {
        return new Ministere().id(2L).nomMinistere("nomMinistere2").sigleMinistere("sigleMinistere2");
    }
