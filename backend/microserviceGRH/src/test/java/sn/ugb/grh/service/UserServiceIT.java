...
import sn.ugb.grh.config.Constants;
import sn.ugb.grh.domain.User;
import sn.ugb.grh.repository.UserRepository;
import sn.ugb.grh.repository.search.UserSearchRepository;
import sn.ugb.grh.security.AuthoritiesConstants;
import sn.ugb.grh.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the sn.ugb.grh.repository.search test package.
     *
     * @see sn.ugb.grh.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
