...
import sn.ugb.aua.web.rest.errors.ElasticsearchExceptionMapper;
...
public class LaboratoireResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<LaboratoireDTO> createLaboratoire(@RequestBody LaboratoireDTO laboratoireDTO) throws URISyntaxException {
    ...
    public ResponseEntity<LaboratoireDTO> updateLaboratoire(
        ...
        @RequestBody LaboratoireDTO laboratoireDTO
    ...
    /**
     * {@code SEARCH  /laboratoires/_search?query=:query} : search for the laboratoire corresponding
     * to the query.
     *
     * @param query the query of the laboratoire search.
     * @param pageable the pagination information.
     * @return the result of the search.
     */
    @GetMapping("/_search")
    public ResponseEntity<List<LaboratoireDTO>> searchLaboratoires(
        @RequestParam("query") String query,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to search for a page of Laboratoires for query {}", query);
        try {
            Page<LaboratoireDTO> page = laboratoireService.search(query, pageable);
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
            return ResponseEntity.ok().headers(headers).body(page.getContent());
