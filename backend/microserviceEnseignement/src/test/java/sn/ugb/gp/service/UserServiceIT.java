...
import sn.ugb.gp.domain.User;
import sn.ugb.gp.repository.UserRepository;
import sn.ugb.gp.repository.search.UserSearchRepository;
import sn.ugb.gp.security.AuthoritiesConstants;
import sn.ugb.gp.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the sn.ugb.gp.repository.search test package.
     *
     * @see sn.ugb.gp.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
