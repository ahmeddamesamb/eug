...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "enseignement")
...
public class Enseignement implements Serializable {
    ...
    public Boolean getGroupeYN() {
        return this.groupeYN;
    }

    public Enseignement groupeYN(Boolean groupeYN) {
        this.setGroupeYN(groupeYN);
        return this;
    }

    public void setGroupeYN(Boolean groupeYN) {
