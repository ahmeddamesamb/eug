...
import sn.ugb.ged.domain.User;
import sn.ugb.ged.repository.UserRepository;
import sn.ugb.ged.repository.search.UserSearchRepository;
import sn.ugb.ged.security.AuthoritiesConstants;
import sn.ugb.ged.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the sn.ugb.ged.repository.search test package.
     *
     * @see sn.ugb.ged.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
