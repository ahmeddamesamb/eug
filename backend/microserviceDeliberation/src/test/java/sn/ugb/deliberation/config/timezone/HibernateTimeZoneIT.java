package sn.ugb.deliberation.config.timezone;
...
import sn.ugb.deliberation.repository.timezone.DateTimeWrapper;
import sn.ugb.deliberation.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ugb_date_time_wrapper where id=%d", fieldName, id);
    }
