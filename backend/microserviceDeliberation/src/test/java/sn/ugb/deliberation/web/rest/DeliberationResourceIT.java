...
class DeliberationResourceIT {
    ...
    private static final Integer DEFAULT_EST_VALIDEE = 1;
    private static final Integer UPDATED_EST_VALIDEE = 2;
    ...
    void createDeliberation() throws Exception {
        ...
        assertThat(testDeliberation.getEstValidee()).isEqualTo(DEFAULT_EST_VALIDEE);
    ...
    void putExistingDeliberation() throws Exception {
        ...
        Deliberation testDeliberation = deliberationList.get(deliberationList.size() - 1);
        assertThat(testDeliberation.getEstValidee()).isEqualTo(UPDATED_EST_VALIDEE);
    ...
    void partialUpdateDeliberationWithPatch() throws Exception {
        ...
        partialUpdatedDeliberation.estValidee(UPDATED_EST_VALIDEE);
