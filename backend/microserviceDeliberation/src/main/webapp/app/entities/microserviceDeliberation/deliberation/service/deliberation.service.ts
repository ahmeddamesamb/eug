...
export class DeliberationService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/deliberations/_search', 'microservicedeliberation');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    ...
    return this.http
      ...
      .pipe(catchError(() => scheduled([new HttpResponse<IDeliberation[]>()], asapScheduler)));
  }
